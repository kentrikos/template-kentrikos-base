...
jenkins_config_repo_url = "{{jenkins_config_repo_url}}"
...
jenkins_http_allowed_cidrs = ["{{jenkins_http_allowed_cidrs}}"]

jenkins_ssh_allowed_cidrs = ["{{jenkins_ssh_allowed_cidrs}}"]
