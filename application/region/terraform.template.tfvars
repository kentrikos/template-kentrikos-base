...
http_proxy = "{{application_http_proxy}}"
...
k8s_private_subnets = ["{{private_subnet1_id}}", "{{private_subnet2_id}}", "{{private_subnet3_id}}"]
...
k8s_public_subnets = ["{{public_subnet1_id}}", "{{public_subnet2_id}}", "{{public_subnet3_id}}"]
...
iam_cross_account_role_arn = "arn:aws:iam::{{application_aws_account_number}}:role/KopsCrossAccount"
